...
`ReservationServiceTest` (business rules). Evidence: [`evidence-and-evolution.md`](evidence-and-evolution.md)
and [`evidence/spike-A-persistence-run.log`](evidence/spike-A-persistence-run.log).
